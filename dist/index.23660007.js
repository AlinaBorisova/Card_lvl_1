...
const regExp = ()=>{
    ...
    inputNumber.addEventListener("keydown", (0, _maskJs.numberInputKeyDownHandler));
    inputNumber.addEventListener("input", (0, _maskJs.numberInputInputHandler));
    inputExipry.addEventListener("keydown", (0, _maskJs.expiryInputKeyDownHandler));
    inputExipry.addEventListener("input", (0, _maskJs.expiryInputInputHandler));
    cvvInput.addEventListener("input", (0, _maskJs.cvvInputInputHandler));
...
(0, _redom.setChildren)(document.body, (0, _createJs.card)());
regExp();

},{"redom":"iahd6","./create.js":"eec5Y","./mask.js":"forxf"}],"iahd6":[function(require,module,exports) {
...
},{}],"eec5Y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const card = ()=>{
    ...
    }, cardNumber, cardPersonal);
    const secure = (0, _redom.el)("p", {
        className: "secure"
    });
    secure.textContent = "Secure Checkout";
    const holderLabel = (0, _redom.el)("label", {
        className: "form__label form__holder-label"
    });
    holderLabel.textContent = "Card Holder";
    const inputHolder = (0, _redom.el)("input", {
        type: "text"
    }, {
        className: "input input__holder"
    });
    const formHolder = (0, _redom.el)("div", {
    ...
    const formDate = (0, _redom.el)("div", {
    ...
    const form = (0, _redom.el)("form", {
        ...
        className: "form",
        id: "form"
    }, formHolder, formNumber, formDate, formCvv, button);
...
},{"redom":"iahd6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"forxf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "numberInputKeyDownHandler", ()=>numberInputKeyDownHandler);
parcelHelpers.export(exports, "numberInputInputHandler", ()=>numberInputInputHandler);
parcelHelpers.export(exports, "cvvInputInputHandler", ()=>cvvInputInputHandler);
parcelHelpers.export(exports, "expiryInputKeyDownHandler", ()=>expiryInputKeyDownHandler);
parcelHelpers.export(exports, "expiryInputInputHandler", ()=>expiryInputInputHandler);
...
const numberInputInputHandler = (e)=>{
    ...
    if (newValue.match(numberPattern)) {
        ...
        newCursorPosition = numberInputOldCursor - checkSeparator(numberInputOldCursor, 4) + checkSeparator(numberInputOldCursor + (newValue.length - numberInputOldValue.length), 4) + (unmask(newValue).length - unmask(numberInputOldValue).length);
...
const cvvInputInputHandler = (e)=>{
    let el = e.target;
    let limitCvv = 3;
    el.value = unmask(el.value);
    if (el.value.length >= limitCvv) el.value = el.value.substring(0, limitCvv);
};
const expiryInputKeyDownHandler = (e)=>{
    let el = e.target;
    expiryInputOldValue = el.value;
    expiryInputOldCursor = el.selectionEnd;
};
const expiryInputInputHandler = (e)=>{
    let el = e.target;
    ...
    if (newValue.match(expiryPattern)) {
        ...
        el.value = newValue;
    } else el.value = expiryInputOldValue;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lwNxC","fgDBQ"], "fgDBQ", "parcelRequire7921")
